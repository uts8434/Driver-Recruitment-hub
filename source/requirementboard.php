...
<div id="apDiv2">
  <table width="808" height="468" cellpadding="10" cellspacing="5" border="1">
    ...
    <tr>
      <th scope="row">Car driver</th>
      <td>
	  <?php
       $query ="SELECT * FROM `requirement` WHERE `postname`= 'car driver'" ;
    ...
    <tr>
      ...
      <td><?php
       $query ="SELECT * FROM `requirement` WHERE `postname`= 'taxi driver'" ;
	   $result=mysqli_query($conn,$query);
    ...
    <tr>
      ...
      <td><?php
       $query ="SELECT * FROM `requirement` WHERE `postname`= 'truck driver'" ;
	   $result=mysqli_query($conn,$query);
    ...
    <tr>
      <th scope="row">Ambulance driver</th>
      <td><?php
       $query ="SELECT * FROM `requirement` WHERE `postname`= 'ambulance driver'" ;
	   $result=mysqli_query($conn,$query);
    ...
    <tr>
      <th scope="row">Bus driver</th>
      <td><?php
       $query ="SELECT * FROM `requirement` WHERE `postname`= 'bus driver'" ;
	   $result=mysqli_query($conn,$query);
    ...
    <tr>
      <th scope="row">Racing driver</th>
      <td><?php
       $query ="SELECT * FROM `requirement` WHERE `postname`= 'racing driver'" ;
	   $result=mysqli_query($conn,$query);
