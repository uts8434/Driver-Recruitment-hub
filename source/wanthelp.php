...
<body>
	...
	<div id="apDiv13">
		<form id="wanthelp" name="wanthelp" action="wanthelpprocessing.php" method="post">
			<table width="100%" height="100%" align="center" cellpadding="5px" cellspacing="10px">

				<tr>

					<td>

						<label>If you want administrative help, please fill the form given below : </label>
					</td>
				</tr>
				<tr>
					<td><input type="text" size="80" required="required" id="helpsubject" name="helpsubject" placeholder="subject" class="formfield" /></td>
				</tr>
				<tr>
					<td><textarea rows="20" cols="79" required="required" id="textarea" name="helpcontent" class="formfield" style="border-radius:8px; padding:10px" placeholder="Problem description"></textarea></td>
				</tr>
				<tr>
					<td colspan="2" align="center"><input type="submit" id="asubmit" name="asubmit" value="Send" /></td>
				</tr>
	...
	<div id="apDiv4"><a href="myaccount.php">upcoming vacancy</a></div>
