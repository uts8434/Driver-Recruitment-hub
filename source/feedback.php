...
?> </div>
<div id="apDiv13">
<form id="feedback" name="feedback" action="feedbackprocessing.php" method="post">
  ...
  <tr>
    ...
    <label>Give feedback and suggestions to improve our system.</label></td>
      </tr>
      
      <tr>
      <td><textarea  cols="75" rows="10"required="required" id="textarea" name="feedback" class="formfield" style="border-radius:8px; padding:10px"></textarea></td>
    </tr>
         <tr>
